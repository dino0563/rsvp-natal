...
<head>
  ...
  *,*::before,*::after{ box-sizing:border-box; }
  ...
  body{
    ...
    color: #1b1b1b;
    /* Brand gradient pakai var dari theme-section (section: ticket) */
    background:
      radial-gradient(130% 70% at 50% -10%, color-mix(in srgb, var(--brand) 18%, white) 0 40%, transparent 70%) no-repeat,
  ...
  .card{
    ...
    /* Kertas & border bernuansa gold */
    background:
      linear-gradient(var(--paper, #fff9f1), var(--paper, #fff9f1)) padding-box,
      linear-gradient(180deg,
        color-mix(in srgb, var(--paper, #fff9f1) 96%, white 4%),
        color-mix(in srgb, var(--gold, #d9b86c) 55%, var(--paper, #fff9f1) 45%)
      ) border-box;
  ...
  .title{
    margin:0; font-family:'ChettaVissto','Cormorant Garamond',serif;
    font-size:clamp(36px,5vw,64px); line-height:1.1; letter-spacing:.4px;
  }
  .event-title{
    margin:0; font-family:'ChettaVissto','Cormorant Garamond',serif;
    font-size:clamp(30px,4vw,40px); letter-spacing:.4px;
  }
  .subtitle{ margin:6px 0 0; opacity:.92 }

  .card-body{ padding:30px clamp(18px,5vw,36px) 34px; }
  .ticket{
    border:1px dashed color-mix(in srgb, var(--gold, #d9b86c) 42%, var(--paper, #fff9f1) 58%);
    border-radius:18px;
  ...
  .meta p{ margin:6px 0; }
  .note{ font-size:12px; color: color-mix(in srgb, var(--pine, #165b36) 30%, #1b1b1b 70%); margin-top:10px; }

  .footer{
    background: color-mix(in srgb, var(--gold, #d9b86c) 22%, white);
    color: color-mix(in srgb, var(--pine, #165b36) 55%, black 45%);
    text-align:center; font-size:12px; padding:14px 20px;
  ...
  .badge{
    ...
    background: var(--pine, #165b36); color: #fff;
  }
